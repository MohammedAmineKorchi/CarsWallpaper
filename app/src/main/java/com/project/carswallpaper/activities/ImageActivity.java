...
import com.project.carswallpaper.models.Wallpaper;
...
public class ImageActivity extends AppCompatActivity {
                    ...
                    public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                        if (android.os.Build.VERSION.SDK_INT <= Build.VERSION_CODES.LOLLIPOP_MR1) {
                            Picasso.get().load(wallpaper).into(new Target() {
                                ...
                                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                                    ...
                                    try {
                                        ...
                                        File myDir = new File(root + "/Cars Wallpaper");
                            ...
                            if (uri != null) {
                                ...
                                getBaseContext().startActivity(Intent.createChooser(intent, "Cars Wallpaper"));
                                Snackbar.make(r, "Wallpaper Saved", Snackbar.LENGTH_INDEFINITE).setAction("Done", new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
    ...
    private Uri saveWallpaperAndGetURI(Bitmap bitmap,String id){
        ...
        File folder = new File(Environment.getExternalStorageDirectory().toString(),"/Cars Wallpaper");
        folder.mkdir();
